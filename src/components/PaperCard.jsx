...
const PaperCard = ({ paper, onViewDetails }) => {
    ...
    const pdfUrl = paper.PDF || paper.pdf;
    const videoUrl = paper.Video || paper.video;
    ...
    return (
        <div
            ...
            style={{ backgroundColor: '#dcc1a6' }} // Applied the requested olive color
        >
            <div>
                ...
                {/* Content Area - Removed bg-white to let the card color show through */}
